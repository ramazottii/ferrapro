...
def pick(t,rules,default):
 ...
 return default
rules={
'Hijyen':[(r'ıslak|temizleme mendili','wipes'),(r'dispenseri|örtüsü dispenser','dispenser'),(r'kutu mendil|cep mendil|yüz havlu','tissue'),(r'peçete|mendil','pecete'),(r'fotosel|içten çekmeli havlu|hareketli havlu','fotosel2'),(r'jumbo|cimri','jumbo'),(r'tuvalet','tuvalet'),(r'havlu','jumbo')],
