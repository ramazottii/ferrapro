...
priority={
 ...
 'Kırtasiye':[(r'fotoğraf kâğıdı','photopaper'),(r'renkli fotokopi','colorream'),(r'plotter','plotter'),(r'fineliner','fineliner'),(r'beyaz tahta kalem|permanent marker|asetat','wbmarker'),(r'mantar pano','corkboard'),(r'flipchart','flipchart'),(r'pano mıknat','boardmagnet'),(r'cilt spirali','bindcoil'),(r'dosya ayracı','filetabs'),(r'askılı dosya','hangingfile'),(r'sunum dosya','displaybook'),(r'imza dosya','signfolder'),(r'körüklü','accordionfile'),(r'telli dosya|sıkıştırmalı|proje dosya','fastenerfile'),(r'sert kapaklı|ajanda|fihrist|ticari defter','hardcover'),(r'sayfa ışaret|sayfa işaret','pageflags'),(r'zımba sök','stapleremover'),(r'raptiye|harita çivi','pushpins'),(r'evrak mandal','binderclips'),(r'ataş','paperclips'),(r'kalemlik','pencup'),(r'evrak raf','papertray'),(r'magazinlik','magrack'),(r'kartvizitlik','cardholder'),(r'hava kabarcıklı','bubblemailer'),(r'düğme pil','buttonbatt'),(r'9v pil','ninevolt'),(r'paket lasti','rubberbands'),(r'bant kesici','tapeholder'),(r'bandı|bant','taperolls'),(r'poşet dosya','dosya'),(r'ıstampa mürekkebi','inkbottle')]
}
