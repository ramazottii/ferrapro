...
priority={
 ...
 'Temizlik':[(r'köpük sabun dispenser','foamdisp'),(r'sıvı sabun dispenser','soapdisp'),(r'köpük el sabunu','foamsoap'),(r'sıvı el sabunu 5','soap5l'),(r'çöp poşet.*mavi','copblue'),(r'çöp poşet.*şeffaf','copclear'),(r'çöp poşet','copblack'),(r'toz.*deterjan|deterjanı 10 kg|kapsül|makinesi tuzu','drycleaning')],
